...
def find_box_spreads(df):
    ...
    for (client, ticker, maturity), group in grouped:
        ...
        print(f"Initial Calls:\n{calls[['strike', 'quantity']]}")
        print(f"Initial Puts:\n{puts[['strike', 'quantity']]}")
...
def identify_spread(client, ticker, maturity, calls, puts, remaining_quantities, boxes, spread_type="Long"):
    ...
    print(f"\nStarting {spread_type} Box Spread identification...")
    print(f"Remaining quantities before identification:\n{remaining_quantities}")
        ...
        for _, matching_call in calls.iterrows():
            ...
            for _, matching_put_sell in puts.iterrows():
                ...
                for _, matching_put_buy in puts.iterrows():
                    ...
                    if box_quantity > 0:
                        print(f"Identified {spread_type} Box Spread:")
                        print(f"  - Quantity: {box_quantity}")
                        print(f"  - Buy Call Strike: {call['strike']}")
                        print(f"  - Sell Call Strike: {matching_call['strike']}")
                        print(f"  - Sell Put Strike: {matching_put_sell['strike']}")
                        print(f"  - Buy Put Strike: {matching_put_buy['strike']}")
                        print(f"Remaining quantities BEFORE adjustment:\n{remaining_quantities}")
                        ...
                        print(f"Remaining quantities AFTER adjustment:\n{remaining_quantities}")
